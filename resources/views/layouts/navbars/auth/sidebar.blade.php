...
sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 z-0"
    ...
    <div>
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'podcast' ? 'active' : '' }}"
                    wire:navigate
                    href="{{ route('podcast') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            ...
                            viewBox="0 0 448 512"
                            class="{{ request()->routeIs('podcast') ? 'text-white' : 'text-dark' }}"
                            style="width: 24px; height: 24px; {{ request()->routeIs('podcast') ? 'fill: white;' : 'fill: black;' }}">
