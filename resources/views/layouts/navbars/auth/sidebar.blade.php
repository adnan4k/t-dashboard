...
sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 z-0"
    ...
    <div>
        <ul class="navbar-nav">
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'sliders' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('sliders') ? 'fill: white;' : 'fill: black;' }}"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'packages' ? 'active' : '' }}"
                    wire:navigate href="{{ route('packages') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="{{ request()->routeIs('slider') ? 'text-white' : 'text-dark' }}"
                            style="width: 24px; height: 24px; {{ request()->routeIs('packages') ? 'fill: white;' : 'fill: black;' }}"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M216 64c-13.3 0-24 10.7-24 24s10.7 24 24 24l16 0 0 33.3C119.6 157.2 32 252.4 32 368l448 0c0-115.6-87.6-210.8-200-222.7l0-33.3 16 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-40 0-40 0zM24 400c-13.3 0-24 10.7-24 24s10.7 24 24 24l464 0c13.3 0 24-10.7 24-24s-10.7-24-24-24L24 400z" />
                        </svg>
                    </div>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'vacancies' ? 'active' : '' }}"
                    wire:navigate href="{{ route('vacancies') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="{{ request()->routeIs('vacancies') ? 'text-white' : 'text-dark' }}"
                            style="width: 24px; height: 24px; {{ request()->routeIs('vacancies') ? 'fill: white;' : 'fill: black;' }}"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'scholarships' ? 'active' : '' }}"
                    wire:navigate href="{{ route('scholarships') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="{{ request()->routeIs('scholarships') ? 'text-white' : 'text-dark' }}"
                            style="width: 24px; height: 24px; {{ request()->routeIs('scholarships') ? 'fill: white;' : 'fill: black;' }}"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'contact' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('contact') ? 'fill: white;' : 'fill: black;' }}"
            ...
            <!-- <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'partnership' ? 'active' : '' }}"
                    wire:navigate href="{{ route('partnership') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="{{ request()->routeIs('partnership') ? 'text-white' : 'text-dark' }}"
                            style="width: 24px; height: 24px; {{ request()->routeIs('partnership') ? 'fill: white;' : 'fill: black;' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'testimonials' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('testimonials') ? 'fill: white;' : 'fill: black;' }}"
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'booking' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('booking') ? 'fill: white;' : 'fill: black;' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'sections' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('sections') ? 'fill: white;' : 'fill: black;' }}"
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'subscription' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('subscription') ? 'fill: white;' : 'fill: black;' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'tour' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('tour') ? 'fill: white;' : 'fill: black;' }}"
                ...
                <a class="nav-link {{ Route::currentRouteName() == 'schedule' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; {{ request()->routeIs('schedule') ? 'fill: white;' : 'fill: black;' }}"
