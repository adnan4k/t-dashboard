        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <a href="javascript:void(0)" class="switch-trigger background-color">
                <div class="badge-colors my-2 text-start">
                    <span class="badge filter bg-green-400 active" data-color="primary"
            ...
            <div class="d-flex">
                <button class="btn bg-green-400 w-100 px-3 mb-2 active" data-class="bg-transparent"
                    onclick="sidebarType(this)">Transparent</button>
                <button class="btn bg-green-400 w-100 px-3 mb-2 ms-2" data-class="bg-white"
...
<?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/components/plugins/fixed-plugin.blade.php ENDPATH**/ ?>