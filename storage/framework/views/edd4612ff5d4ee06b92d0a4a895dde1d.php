              ...
              <div class="col-8">
                <div class="numbers">
                  ...
                  <h5 class="font-weight-bolder mb-0">
                    <?php echo e($podcastCount); ?> Episodes
                  </h5>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-8">
                <div class="numbers">
                  ...
                  <h5 class="font-weight-bolder mb-0">
                    <?php echo e($scholarship); ?> Scholarships
                  </h5>
                </div>
              </div>
              <div class="col-4 text-end">
...
</main><?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/livewire/dashboard.blade.php ENDPATH**/ ?>