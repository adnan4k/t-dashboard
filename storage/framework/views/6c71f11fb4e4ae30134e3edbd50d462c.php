<aside class="
sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 z-0"
    id="sidenav-main">
    ...
    <div>
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a wire:navigate class="nav-link <?php echo e(Route::currentRouteName() == 'category' ? 'active' : ''); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'blogs' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('blogs')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('blogs') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('blogs') ? 'fill: white;' : 'fill: black;'); ?>"
                ...
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'sliders' ? 'active' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg
                            ...
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('sliders') ? 'fill: white;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'packages' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('packages')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('slider') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('packages') ? 'fill: white;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                            <path d="M216 64c-13.3 0-24 10.7-24 24s10.7 24 24 24l16 0 0 33.3C119.6 157.2 32 252.4 32 368l448 0c0-115.6-87.6-210.8-200-222.7l0-33.3 16 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-40 0-40 0zM24 400c-13.3 0-24 10.7-24 24s10.7 24 24 24l464 0c13.3 0 24-10.7 24-24s-10.7-24-24-24L24 400z" />
                        </svg>
                    </div>
            ...
            <!-- <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'biography' ? 'active' : ''); ?>"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('biography') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('biography') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <!-- <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'vacancies' ? 'active' : ''); ?>"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('vacancies') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('vacancies') ? 'fill: white;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'scholarships' ? 'active' : ''); ?>"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg
                            class="<?php echo e(request()->routeIs('scholarships') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('scholarships') ? 'fill: white;' : 'fill: black;'); ?>"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'contact' ? 'active' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg
                            class="<?php echo e(request()->routeIs('contact') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('contact') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <!-- <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'partnership' ? 'active' : ''); ?>"
                    ...
                    <div
                        ...
                        <svg
                            class="<?php echo e(request()->routeIs('partnership') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('partnership') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'testimonials' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('testimonials')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('testimonials') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('testimonials') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'booking' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('booking')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('booking') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('booking') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'sections' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('sections')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('sections') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('sections') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'subscription' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('subscription')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('subscription') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('subscription') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'tour' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('tour')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('tour') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('tour') ? 'fill: white;' : 'fill: black;'); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'schedule' ? 'active' : ''); ?>"
                    wire:navigate href="<?php echo e(route('schedule')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

                        <svg
                            class="<?php echo e(request()->routeIs('schedule') ? 'text-white' : 'text-dark'); ?>"
                            style="width: 24px; height: 24px; <?php echo e(request()->routeIs('schedule') ? 'fill: white;' : 'fill: black;'); ?>"
...
</aside><?php /**PATH /home/faysal/Desktop/apps/kasma/tour-travel-dashbaord/resources/views/layouts/navbars/auth/sidebar.blade.php ENDPATH**/ ?>