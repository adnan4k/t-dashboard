          ...
          <div class="container">
              <div class="row justify-content-center">
                  <div class="col-lg-5 text-center mx-auto">
                      <h1 class="text-white mb-2 mt-5"><?php echo e(__('Welcome!')); ?></h1>
                      <p class="text-lead text-white">
                          <?php echo e(__('Use these awesome forms to login or create new account in your
                          project for free.')); ?>
              ...
              <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                  <div class="card z-index-0">
                      <div class="card-header text-center pt-4">
                          <h5><?php echo e(__('Register with')); ?></h5>
                      </div>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-check form-check-info text-left">
                                  ...
                                  <label class="form-check-label" for="flexCheckDefault">
                                      <?php echo e(__('I agree the')); ?> <a href="javascript:;"
                                          class="text-dark font-weight-bolder"><?php echo e(__('Terms
                                          and
                                          Conditions')); ?></a>
                                  </label>
                              </div>
...
<?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/livewire/auth/sign-up.blade.php ENDPATH**/ ?>