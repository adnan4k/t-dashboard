        ...
        <div
            ...
            <form class="relative bg-white rounded-lg shadow dark:bg-gray-700" wire:submit.prevent="save">
                <div class="flex flex-wrap border shadow rounded-lg p-3 dark:bg-gray-600">
                    <h2 class="text-xl text-gray-600 dark:text-gray-300 pb-2">Create Service</h2>
...
</div><?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/livewire/services/form.blade.php ENDPATH**/ ?>