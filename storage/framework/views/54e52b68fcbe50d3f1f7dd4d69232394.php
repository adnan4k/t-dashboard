<div class="flex justify-center px-6 py-8 bg-gray-50 min-h-screen">
    <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg p-8 dark:bg-gray-800">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($vacancy->title); ?></h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Posted on: <?php echo e($vacancy->created_at->format('M d, Y')); ?></p>
        </div>
        ...
        <div class="mb-8 border-b pb-6 border-gray-200 dark:border-gray-700">
            ...
            <p class="text-gray-600 dark:text-gray-300 mt-4"><?php echo e($vacancy->description); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->experience); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Job Type</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->jobType); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Location</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->location); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Languages</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->languages); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Start Date</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->startDate->format('M d, Y')); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Deadline</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->deadline->format('M d, Y')); ?></p>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <ul class="list-disc list-inside text-gray-600 dark:text-gray-300 mt-4 space-y-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = explode("\n", $vacancy->keyResponsibilities); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsibility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 mt-4"><?php echo e($vacancy->qualifications); ?></p>
        </div>
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->email); ?></p>
            </div>
            <div>
                <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300">Phone Number</h3>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($vacancy->phone); ?></p>
            </div>
        </div>
...
<?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/livewire/opportunity/vacancy/detail.blade.php ENDPATH**/ ?>