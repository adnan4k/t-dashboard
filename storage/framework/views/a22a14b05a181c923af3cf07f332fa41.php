                            ...
                            <div class="w-full mx-auto p-4 sm:p-6">
                                <div class="grid ">
                                    <div class="rounded overflow-hidden shadow-lg">
                                        <div class="relative">
                                            <!--[if BLOCK]><![endif]--><?php if($biography && $biography->image): ?>
                                                <div>
                                                    <img
                                                        class="w-full h-64"
                                                        src="<?php echo e(asset($biography->image)); ?>"
                                                        allowFullScreen />
                                                </div>
                                                ...
                                                <div class="absolute bottom-0 left-0 bg-indigo-600 text-white px-4 py-2 text-sm">
                                                    Position <?php echo e($biography->position ?? 'Not specified'); ?>
                                        ...
                                        <div class="p-4">
                                            <a href="#" class="font-semibold text-lg text-gray-900 dark:text-gray-200 hover:text-indigo-600 transition">
                                                <?php echo e($biography->name ?? 'No name available'); ?>

                                            </a>
                                            <p class="text-gray-600 dark:text-gray-400 text-sm mt-2">
                                                <?php echo e($biography->detail ?? 'No details available'); ?>
...
<?php /**PATH /home/faysal/Music/hakim-dashboard/resources/views/livewire/boiography/detail.blade.php ENDPATH**/ ?>