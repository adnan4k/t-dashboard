<div role="status" id="toaster" x-data="toasterHub(<?php echo \Illuminate\Support\Js::from($toasts)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($config)->toHtml() ?>)" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
    ...
    <template x-for="toast in toasts" :key="toast.id">
        ...
        >
            ...
            <?php if($closeable): ?>
            <button @click="toast.dispose()" aria-label="<?php echo app('translator')->get('close'); ?>" class="absolute right-0 p-2 focus:outline-none rtl:right-auto rtl:left-0 <?php echo e($alignment->is('bottom') ? 'top-3' : 'top-0'); ?>">
...
<?php /**PATH /home/faysal/Desktop/apps/kasma/tour-travel-dashbaord/vendor/masmerise/livewire-toaster/src/../resources/views/hub.blade.php ENDPATH**/ ?>